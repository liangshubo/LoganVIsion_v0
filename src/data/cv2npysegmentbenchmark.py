...
class Cv2NPYSegmentBenchmark(BaseDataset):
    def __init__(self,args,test_dataset_name=None):
        super(Cv2NPYSegmentBenchmark,self).__init__(args,test_dataset_name)
...
if __name__ == '__main__':
    ...
    dataset = SegmentBenchmark_Edge(args, test_dataset_name="n6000_shoulder_segment")
