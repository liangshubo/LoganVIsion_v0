...
class Cv2SegmentDataset_Cop_Class(Cv2SegmentDataset):
    def __init__(self,args,train_dataset_name=None):
        super(Cv2SegmentDataset_Cop_Class,self).__init__(args,train_dataset_name)
    ...
    def __getitem__(self, idx):
        ...
        tensor_image, tensor_gt ,tensor_label,plane_channel_idx_tensor= self.load_file(image, gt,label)
        return tensor_image, tensor_gt,tensor_label,plane_channel_idx_tensor
    ...
    def load_file(self, image, gt, label):
       ...
       # plane_channel_idx_tensor =  plane_channel_idx_tensor.unsqueeze(0)
        ...
        #print(plane_channel_idx_tensor.shape,"plane_channel_idx_tensor.shape")
        return image_tensor, gt_tensor, label_tensor,plane_channel_idx_tensor
...
if __name__ == '__main__':
    ...
    dataset = Cv2SegmentDataset_Cop_Class(args, train_dataset_name="n6000_shoulder_segment_828_cop_class")
    image, label,gt,channel = dataset.__getitem__(55)
