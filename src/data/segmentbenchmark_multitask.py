...
class SegmentBenchmark_multitask(SegmentBenchmark):
    def __init__(self,args,test_dataset_name=None):
        super(SegmentBenchmark_multitask,self).__init__(args,test_dataset_name)
...
if __name__ == '__main__':
    ...
    dataset = SegmentBenchmark_multitask(args, test_dataset_name="n6000_shoulder_segment_828_cop_class")
