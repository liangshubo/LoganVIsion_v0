...
def move_and_rename_cv_twoclass(path,save_path):
    ...
    m = 0
    for j in range(0,len(real_name_list_cv),4):
        ...
        cv_4 = os.path.join(path, real_name_list_cv[j+2])
        cv_5 = os.path.join(path, real_name_list_cv[j + 3])
...
path =r"E:\Project_Thyroid\dataset\__093958_samsung_thyroid_sci1sharm_cv2345_num16"
save_path = r"E:\Project_Thyroid\dataset\dicom"
#rename_and_copy(path,save_path)

rename_cv0(path,save_path, n =16)
