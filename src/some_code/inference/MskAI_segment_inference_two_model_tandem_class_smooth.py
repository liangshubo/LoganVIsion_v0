        ...
        for nameext in name_list:
            ...
            with (torch.no_grad()):
                ...
                if prev_logits_ema is None:
                    logits_smooth = segment_output
                else:
                    logits_smooth = segment_postprocess.temporal_smoothing_v2(prev_logits_ema,segment_output,args.num_class)
                # prev_logits_ema = segment_output
                prev_logits_ema = logits_smooth
...
if __name__ == '__main__':
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = '0'
    # 1. 指定模型
    args.model_class = "resnet"#"convnext"   # "resnet"
    args.model_segment = "segxnet"#"deeplabv3_channel"   # "segxnet"
    args.resume = 0
    args.cpu = False
    #resnet
    ...
    # [ResNet50DeepLabV3-EX11-planeInput_yueshuattention]-[n6000_shoulder_segment_924_cop_class]-[2025-09-25-09-06] # [Segnext-EX11-planeInput_segment]-[n20n6000_shoulder_segment_cop_class_all_1013]-[2025-10-22-16-50]
    ...
    for i in range(len(input_path_list)):
        ...
        input_folder= r"/home/ubuntu4090/4T_disk/liangshubo/MSKAI/PreExp/dataset/rawdata/all_sam418_data_segment/png/test/image/"+input_path_list[i]
        ...
        args.inference_path = r"/home/ubuntu4090/4T_disk/liangshubo/MSKAI/PreExp/dataset/rawdata/all_sam418_data_segment/test_inference/inference_class_tendom_segment"
