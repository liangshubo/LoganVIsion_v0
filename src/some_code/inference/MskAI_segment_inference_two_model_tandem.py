...
这一个代码是用于 单输入的推理 ，其中有两个模型 一个用来分类一个用来分割
...
if __name__ == '__main__':
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = '0'
    # 1. 指定模型
    args.model_class = "convnext"#"convnext"
    args.model_segment = "segxnet"#"deeplabv3_channel"
    args.resume = 0
    args.cpu = False
    #resnet
    #args.pre_train_class = "[AttentionResNet50-n20-n6000-EX1]-[n20n6000_shoulder_class_all_1013]-[2025-10-13-17-37]"  # "[NAFNet-BlEX12]-[Test_Dataset]-[2023-11-20-07-33]"#"[NAFNet-TEX10]-[Patch_1102]-[2023-11-17-09-34]"
    args.pre_train_class = "[Convnext-n20-n6000-EX1]-[n20n6000_shoulder_class_all_1013]-[2025-10-20-14-25]"  # "[NAFNet-BlEX12]-[Test_Dataset]-[2023-11-20-07-33]"#"[NAFNet-TEX10]-[Patch_1102]-[2023-11-17-09-34]"
