...
class Trainer(Trainer_1model_1loss):
    ...
    def summarywrite(self):
        ...
        summary_save_path = r"/home/liangshubo/Project/CTSR/tensorboard"
    ...
    def test(self):
        ...
        self.ckp.write_log('\033[1;35m[ =======> Forward: {:.2f}s, FPS: {:.1f} <======= ] '.format(total_forward_time,
                                                                                                   test_dataset_num / total_forward_time))
    ...
    def eval(self):
        ...
        self.ckp.write_log(
            '\033[1;35m[ =======> Forward: {:.2f}s, FPS: {:.1f} <======= ] '.format(total_evaluation_time,
