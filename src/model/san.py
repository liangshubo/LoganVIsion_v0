...
## Residual  Block (RB)
class RB(nn.Module):
    def __init__(self, conv, n_feat, kernel_size, bias=True, bn=False, act=nn.ReLU(inplace=True), res_scale=1, dilation=2):
...
class SAN(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        self.RG = nn.ModuleList([LSRAG(conv, n_feats, kernel_size, \
