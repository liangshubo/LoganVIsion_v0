...
class DeepLabHeadV3Plus(nn.Module):
    ...
    def forward(self, feature):
        ...
        #  add edge output to
        mask_output = self.classifier(torch.cat([low_level_feature, output_feature], dim=1))
        edge_output = self.edge(mask_output )
...
if __name__ == '__main__':
    import torch
    model = deeplabv3plus_resnet50(33,pretrained_backbone=False)
