...
class BasicBlock(nn.Module):  # 对应18,34层的残差结构,ResNet18/34的残差结构，用的是2个3x3的卷积
...
class AttentionBottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None,width_per_group=64):
...
def resnet50(num_classes=1000, include_top=True):
    ...
    return ResNet(AttentionBottleneck, [3, 4, 6, 3], num_classes=num_classes, include_top=include_top)
...
def make_model(args, parent=False):
    return  resnet50(args.num_class)
