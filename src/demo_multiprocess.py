...
if __name__ == '__main__':
    ...
    args.pre_train = "[Baseline-EVPlus_srblur_EX2]-[EVPelvis_srdataset_lr_blur]-[2024-05-10-07-21]"  # "[NAFNet-BlEX12]-[Test_Dataset]-[2023-11-20-07-33]"#"[NAFNet-TEX10]-[Patch_1102]-[2023-11-17-09-34]"


    input_path_list = ["cv0_dmapdown131_thyroid_sam2_cv1","cv0_dmapdown131_thyroid_sam2_cv2","cv0_dmapdown131_thyroid_sam3_cv2","cv0_dmapdown131_thyroid_sam3_cv3","cv0_dmapdown131_thyroid_sam4_cv4"]
    #save_path_list = []

    for i in range(len(input_path_list)):

        # 3.，指定文件夹路径
        args.input_path = r"/media/ubuntu/SSD_3/Liangshubo/Thyroid_plus/dataset/rawdata/n20_thyroid_v2_pretrain/process_2/"+input_path_list[i]

        # 4. 指定保存路径
        # " # 串联模型的顺序从左到右侧，左就是数据的来源，右就是模型
        args.save_path = r"/media/ubuntu/SSD_3/Liangshubo/Thyroid_plus/dataset/rawdata/n20_thyroid_v2_pretrain/process_3/"+input_path_list[i]+"_srblur"
        # 5. 运行
...
# 726
    ...
    #
    # args.pre_train = "[Baseline-EVPlus_sr_EX1]-[EVPelvis_srdataset_lr]-[2024-05-10-03-12]"  # "[NAFNet-BlEX12]-[Test_Dataset]-[2023-11-20-07-33]"#"[NAFNet-TEX10]-[Patch_1102]-[2023-11-17-09-34]"
    #
    #
    # input_path_list = ["cv0_dmapdown131_thyroid_sam2_cv1","cv0_dmapdown131_thyroid_sam2_cv2","cv0_dmapdown131_thyroid_sam3_cv2","cv0_dmapdown131_thyroid_sam2_cv3","cv0_dmapdown131_thyroid_sam4_cv4"]
    # #save_path_list = []
    #
    # for i in range(len(input_path_list)):
    #
    ...
    #     # 4. 指定保存路径
    #     # " # 串联模型的顺序从左到右侧，左就是数据的来源，右就是模型
    #     args.save_path = r"/media/ubuntu/SSD_3/Liangshubo/Thyroid_plus/dataset/rawdata/n20_thyroid_v2_pretrain/process_3/"+input_path_list[i]+"_sr"
    #     # 5. 运行
    #     if not os.path.exists(args.save_path):
    #         os.makedirs(args.save_path)
    #     model = inference_multi_image(args)
